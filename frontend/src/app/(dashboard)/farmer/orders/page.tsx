...
export default function ManageOrdersPage() {
  ...
  return (
    <div className="flex h-screen bg-[#f3f4f6] font-sans overflow-hidden">
      ...
      {/* LEFT SIDEBAR - preserved exactly as before */}
      <aside className="w-[240px] bg-white border-r border-gray-200 flex flex-col h-full flex-shrink-0 z-20">
        ...
        <div className="flex-1 overflow-y-auto custom-scrollbar py-4">
          ...
          <Link href="/farmer/orders" className="flex items-center px-4 py-2.5 bg-green-50 text-[#2d9a33] border-r-4 border-[#2d9a33] transition-colors justify-between">
            ...
            <span className="text-xs bg-green-100 text-[#2d9a33] px-2 py-0.5 rounded-full">{dashboardData?.summary?.total_orders_received || 0}</span>
          </Link>
